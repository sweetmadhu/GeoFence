...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Intersoft.Crosslight.Android.NonScrollableListView, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", NonScrollableListView.class, __md_methods);
	}


	public NonScrollableListView (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == NonScrollableListView.class)
	...
	public NonScrollableListView (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == NonScrollableListView.class)
	...
	public NonScrollableListView (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == NonScrollableListView.class)
