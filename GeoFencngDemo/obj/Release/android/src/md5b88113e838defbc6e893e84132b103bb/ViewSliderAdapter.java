...
public class ViewSliderAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Intersoft.Crosslight.Android.ViewSliderAdapter, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", ViewSliderAdapter.class, __md_methods);
	}


	public ViewSliderAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ViewSliderAdapter.class)
			mono.android.TypeManager.Activate ("Intersoft.Crosslight.Android.ViewSliderAdapter, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", "", this, new java.lang.Object[] {  });
	}
