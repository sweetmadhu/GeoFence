package md5c68c1a79601f29e2e5619bbc6f8367a4;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Intersoft.Crosslight.Services.Location.Android.LocationService, Intersoft.Crosslight.Services.Location.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", LocationService.class, __md_methods);
	}
	...
	public LocationService () throws java.lang.Throwable
	{
		...
		if (getClass () == LocationService.class)
			mono.android.TypeManager.Activate ("Intersoft.Crosslight.Services.Location.Android.LocationService, Intersoft.Crosslight.Services.Location.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", "", this, new java.lang.Object[] {  });
	}
