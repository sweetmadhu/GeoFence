...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Intersoft.Crosslight.Android.Controls.GenericParcelableCreator`1, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", GenericParcelableCreator_1.class, __md_methods);
	}


	public GenericParcelableCreator_1 () throws java.lang.Throwable
	{
		super ();
		if (getClass () == GenericParcelableCreator_1.class)
			mono.android.TypeManager.Activate ("Intersoft.Crosslight.Android.Controls.GenericParcelableCreator`1, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", "", this, new java.lang.Object[] {  });
	}
