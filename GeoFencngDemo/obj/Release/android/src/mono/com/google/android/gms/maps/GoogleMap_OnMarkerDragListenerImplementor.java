...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Gms.Maps.GoogleMap+IOnMarkerDragListenerImplementor, Xamarin.GooglePlayServices.Maps, Version=1.0.0.0, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", GoogleMap_OnMarkerDragListenerImplementor.class, __md_methods);
	}
	...
	public GoogleMap_OnMarkerDragListenerImplementor () throws java.lang.Throwable
	{
		...
		if (getClass () == GoogleMap_OnMarkerDragListenerImplementor.class)
			mono.android.TypeManager.Activate ("Android.Gms.Maps.GoogleMap+IOnMarkerDragListenerImplementor, Xamarin.GooglePlayServices.Maps, Version=1.0.0.0, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", "", this, new java.lang.Object[] {  });
	}
