...
public class SectionContainerView
	extends md5c3e5393a2cab9fda2012fb6b9167f968.FormContainerView
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("Intersoft.Crosslight.Android.Views.SectionContainerView, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", SectionContainerView.class, __md_methods);
	}
	...
	public SectionContainerView (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == SectionContainerView.class)
