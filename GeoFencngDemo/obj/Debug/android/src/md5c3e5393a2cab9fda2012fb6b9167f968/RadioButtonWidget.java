...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("Intersoft.Crosslight.Android.Views.RadioButtonWidget, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", RadioButtonWidget.class, __md_methods);
	}


	public RadioButtonWidget (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == RadioButtonWidget.class)
			mono.android.TypeManager.Activate ("Intersoft.Crosslight.Android.Views.RadioButtonWidget, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public RadioButtonWidget (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == RadioButtonWidget.class)
	...
	public RadioButtonWidget (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == RadioButtonWidget.class)
	...
	public RadioButtonWidget (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == RadioButtonWidget.class)
