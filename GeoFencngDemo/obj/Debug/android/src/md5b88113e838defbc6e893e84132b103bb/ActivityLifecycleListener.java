...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Intersoft.Crosslight.Android.ActivityLifecycleListener, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", ActivityLifecycleListener.class, __md_methods);
	}


	public ActivityLifecycleListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ActivityLifecycleListener.class)
			mono.android.TypeManager.Activate ("Intersoft.Crosslight.Android.ActivityLifecycleListener, Intersoft.Crosslight.Android, Version=5.0.5000.1, Culture=neutral, PublicKeyToken=71f3e3261ac778b5", "", this, new java.lang.Object[] {  });
	}
